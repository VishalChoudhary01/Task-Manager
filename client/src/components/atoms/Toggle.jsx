  ...
  return (
    <div className="flex items-center justify-center">
      <label className="group relative inline-flex flex-col cursor-pointer items-center">
        ...
        />
        <div
          className="relative md:h-6 md:w-12 w-10 h-5 rounded-full  border-[var(--color-accent)] dark:border-[var(--color-dark-accent)]   transition-all duration-300
                     ...
                     dark:peer-checked:bg-blue-100
                     peer-checked:after:translate-x-6 
                     hover:after:scale-95 active:after:scale-90"
        >
          <span className="absolute inset-0 rounded-full  
                          dark:bg-linear-to-tr bg-linear-to-tl 
                          from-ToggleBg to-ToggleBg3 via-ToggleBg2 
                          from-20% border border-ToggleBg 
                          dark:border-darkToggleBg 
                          dark:from-darkToggleBg dark:via-transparent 
                          dark:to-transparent" />
        </div>
      </label>
    </div>
